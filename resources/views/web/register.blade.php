...
<section class='header' id='header'>
  ...
  <section class='estimate' id='estimate'>
        <div class="container">
            <div class="row-from">
                <h1 class="heading">تسجيل حساب جديد</h1>
                <div class="headul"></div>
                <p class="subheading">قم بتسجيل حساب جديد لكي تتمكن من الاستفادة بكافة الخدمات اونلاين</p>
                    ...
                    <div class='row'>
                        <form action='{{url("register")}}' method='post'>
                            {{csrf_field()}}
                             ...
                             <div class='col-xs-6'>
                                <label>الاسم</label>
                                <input type='text' name="name" placeholder='' class='transition' id='est_in'>
                            </div>

                            <div class='col-xs-6'>
                                <label>البريد الالكتروني</label>
                                <input type='text' name="email" placeholder='' class='transition' id='est_email'>
                            </div>
                            <div class='col-xs-6'>
                                <label>رقم الهاتف</label>
                                <input type='text' name="mobile" placeholder='' class='transition' id='est_phone'>
                            </div>
                            <div class='col-xs-6'>
                                <label>كلمة السر</label>
                                <input type='password' name="password" placeholder='' class='transition' id='est_phone'>
                            </div>

                            <div class='col-xs-12'>
                                <button type='submit' name="submit" class='btn btn-primary enabled transition' id='register'>تسجيل</button>
                            </div>
