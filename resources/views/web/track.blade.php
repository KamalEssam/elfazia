...
<!-- Section End - Header -->
    ...
    <section class='bg-lightgray' id='tracking-app-mobile'>
        <div class="container">
            <div class="row">
                <h1 class="heading">تطبيق الشحن</h1>
                <div class="headul"></div>
                <p class="subheading">Lيمكنك طلب وتتبع وحساب تكلفة شحنتك الان بكل سهولة من خلال تطبيق شركة الشخن الخاص بنا</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="track-order">
                    ...
                    <h1 class="heading">تتبع شحنتك</h1>
                    <p class="subheading">ادخل رقم شحنتك لتعرف الى اين وصلت </p>
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
                        <form method='get' action="" class="track-form">
                            <input type="text" name='ship' placeholder="ادخل رقم الشحنه">
                            <i class="icon icon-magnify"></i>
                        </form>
			<h4> حالة الطلب هي :<span>@if(isset($status)) {{$status}} @endif </span></h4>
                    </div>
                </div>
            </div>
        </div>
