        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="button-box">
                        <div class="btn-group m-r-10">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li>
                                    <a  href="{!! route('deliveries.create') !!}">اضافة جديد</a>
                                </li>
                                ...
                                <li>
                                    <a onclick="event.preventDefault(); deleteRecord('deliveries',datatable)">حذف</a>
                                </li>
                    ...
                    {!! Form::open(['route' => ['deliveries.destroy', 1], 'method' => 'delete','id' => 'delete-form']) !!}
