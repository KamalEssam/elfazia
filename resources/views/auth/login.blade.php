            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <strong>{{ $errors->first('password') }}</strong>
                            ...
                            <button onclick="submit()" class="btn btn-rounded btn-primary btn-block mt-2" type="submit">Sign In</button>
                            <a href="{{url("admin/register")}}"  class="btn btn-rounded btn-primary btn-block mt-2" >Register</a>
