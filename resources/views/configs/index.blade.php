        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="button-box">
                        <div class="btn-group m-r-10">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li>
                                    <a  href="{!! route('configs.create') !!}">اضافة جديد</a>
                                </li>
                                {{--
                                <li>
                                    <a href="{!! route('configs.delete') !!}"
                                ...
                                --}}
                                <li>
                                     <a onclick="event.preventDefault(); deleteRecord('configs',datatable)">حذف</a>
                                </li>
                    ...
                    {!! Form::open(['route' => ['configs.delete'], 'method' => 'delete','id' => 'delete-form']) !!}
