        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="button-box">
                        <div class="btn-group m-r-10">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li>
                                    <a  href="{!! route('cities.create') !!}">اضافة جديد</a>
                                </li>
                                {{--
                                <li>
                                    <a href="{!! route('cities.delete') !!}"
                                ...
                                --}}
                                <li>
                                     <a onclick="event.preventDefault(); deleteRecord('cities',datatable)">حذف</a>
                                </li>
                    ...
                    {!! Form::open(['route' => ['cities.delete'], 'method' => 'delete','id' => 'delete-form']) !!}
